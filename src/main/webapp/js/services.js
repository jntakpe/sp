spApp.factory('UserResource', ['$resource', function ($resource) {
    "use strict";
    return $resource('user');
}]);

spApp.factory('ProjectResource', ['$resource', function ($resource) {
    "use strict";
    return $resource('project');
}]);

spApp.factory('SPAuthService', ['$rootScope', '$http', 'authService', function ($rootScope, $http, authService) {
    "use strict";
    return {
        /**
